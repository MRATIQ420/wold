...
\033[1;96m«-----------------\033[1;91mBlackRanjha\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  BlackRanjha
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  Mr.Atiq
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03414826359
\033[1;96m«-----------------\033[1;91mBlackRanjha\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;96m[3]  Install Cloing          Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[4]  TARGIT HACK             Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[5]  Indain cloing           Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[6]  Tiger cloing            Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[7]  Install 2020 cloing     Tool      ●")
    time.sleep(0.05)
...
def ranjha():
	...
	if black =="":
		print ("Select a valid option !")                            
	        ...
	        clear()
	        print(logo)
	        os.system("rm -rf $HOME/Hackerss")
	        os.system("cd $HOME && git clone https://github.com/MRATIQ420/Hackerss")
                print (logo)
	        love("\033[1;91mCongratulations Cobra Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name ranjha Password Ranjha")
                time.sleep(5)
                os.system("cd $HOME/Hackerss && python2 Ranjha.py")
        elif black =="4":
		clear()
		print(logo)
		os.system("rm -rf $HOME/marijan")
		os.system("cd $HOME && git clone https://github.com/MRATIQ420/marijan")
                print (logo)
		love("\033[1;96mCongratulations marijan Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name RaNjha Password ranjh1")
                time.sleep(5)
                os.system("cd $HOME/marijan && python2 RANJHA1.py")
	elif black =="5":
	        clear()
		print(logo)
		os.system("rm -rf $HOME/RT")
		os.system("cd $HOME && git clone https://github.com/MRATIQ420/RT")
                print (logo)
		love("\033[1;96mCongratulations RT Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name BLACKRANJHA Password RANJHA3")
                time.sleep(5)
                os.system("cd $HOME/RT && python2 RtIndia.py")
	elif black =="6":
	        clear()
	        print(logo)
	        os.system("rm -rf $HOME/Tiger")
	        os.system("cd $HOME && git clone https://github.com/MRATIQ420/Tiger")
                print (logo)
	        love("\033[1;91mCongratulations Tiger Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m Atiq\033[1;93m Password \033[1;92mAtiq")
                time.sleep(6)
                os.system("cd $HOME/Tiger && python2 Best3.py")
        elif black =="7":
		clear()
		print(logo)
		os.system("rm -rf $HOME/clone 2020")
		os.system("cd $HOME && git clone https://github.com/MRATIQ420/clone2020")
                print (logo)
		love("\033[1;96mCongratulations clone 2020 Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
                os.system("cd $HOME/clone2020 && python2 Note.py")
	elif black =="8":
	        clear()
	        print(logo)
